        ...
        <div className="flex justify-center items-center h-[calc(100vh-69px)]">
            <Card className="max-w-4xl w-full bg-white shadow-lg rounded-lg">
                ...
                <CardHeader className="items-center ">
                    ...
                    />
                    <CardTitle className={`${atla.className} scroll-m-20 text-4xl font-semibold tracking-tight`}>Alistair Keiller</CardTitle>
                    <CardDescription className={`${atla.className} text-xl text-gray-500`}>The last CS nerd for fun</CardDescription>
                </CardHeader>
