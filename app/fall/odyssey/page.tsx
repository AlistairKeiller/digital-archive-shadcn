  ...
  return (
    <div className="flex justify-center min-h-[calc(100vh-69px)] bg-gray-100">
      ...
      <div className="mt-6 mx-4 max-w-3xl">
        ...
        <p className="leading-7 [&:not(:first-child)]:mt-6">
          I vividly remember Dr. Giannopoulou&apos;s lecture feeling offputting when she introduced the context for the Odyssey: a hero who appears helpless, out of control, and who resorts to lying for his own ends. Even with Greek contextualization from discussion section, I built a conception of a Greek hero (a being idolized for their physical, mental, divine, and/or financial) that didn&apos;t fit Odysseus. I realize that I was drawing countless biases from Western cultures, like the concept that a smart hero&apos;s decisions always work out. But in reality, that is a construction of false security that results from our society being in denial of death.
        </p>
        <p className="leading-7 [&:not(:first-child)]:mt-6">
