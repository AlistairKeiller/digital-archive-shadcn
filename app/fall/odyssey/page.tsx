    ...
    <div className="flex justify-center min-h-[calc(100vh-69px)]">
      ...
      <div className="mt-6 mx-4 max-w-3xl">
        ...
        <div className="mt-6">
          ...
          <p className="leading-7 [&:not(:first-child)]:mt-6">
            Throughout his epic, Odysseus crafts a tragic tale of a wicked smart troy-destroying mastermind facing the world and losing everything. But this feels like a contradiction: How can a hero, cunning enough to take
            down a city and resourceful enough to kill a cyclops with a pole, be so destitute and
            in need of help at the end of his journey? How could the hero be the beggar?
          </p>
        ...
        <p className="leading-7 [&:not(:first-child)]:mt-6">
          I vividly remember Dr. Giannopoulou&apos;s lecture feeling offputting when she introduced the context for the Odyssey: a hero who appears helpless, out of control, and who resorts to lying for his own ends. Even with Greek contextualization from discussion section, I built a conception of a Greek hero (a being idolized for their physical, mental, divine, and/or financial superiority) that didn&apos;t fit Odysseus. I realize that I was drawing countless biases from Western cultures, like the concept that a smart hero&apos;s decisions always work out. But in reality, that is a construction of false security that results from our society being in denial of death.
        </p>
        <p className="leading-7 [&:not(:first-child)]:mt-6">
